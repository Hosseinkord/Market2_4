<%@ Page Title="Products" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="Products.aspx.cs" Inherits="Market2.Products" %>
            ...
            <section id="intro" class="main">
                <div class="spotlight">
                    <div class="content">
                        ...
                        <ul class="actions">
                            <li><a href="generic.html" class="button">با ما بیشتر آشنا شوید</a></li>
                        </ul>
                    </div>
                    <span class="image">
